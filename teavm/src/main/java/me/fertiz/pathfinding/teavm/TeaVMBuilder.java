package me.fertiz.pathfinding.teavm;
...
public class TeaVMBuilder {
    ...
    public static void main(String[] args) throws IOException {
        ...
        // teaBuildConfiguration.additionalAssetsClasspathFiles.add("me/fertiz/pathfinding/asset.extension");

        // Register any classes or packages that require reflection here:
        // TeaReflectionSupplier.addReflectionClass("me.fertiz.pathfinding.reflect");
